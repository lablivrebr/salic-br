 ...
 */
function carregar_combo(valor, combo, url, txt_combo, campo_selecionado, isCombosMaterialize) {
    ajax = xmlhttp(); // instancia ajax
    ...
    ajax.onreadystatechange = function () {
        ...
        if (ajax.readyState == 4) {
            ...
            if (isCombosMaterialize && isCombosMaterialize == true) {
...
function cadastrar_proponente() // cadastro
{
    ...
    if (cpf == "") {
        ...
        alertar("Por favor, informe o nome!", "nome");
    }
    else if (cep == "") {
        alertar("Por favor, informe o cep!", "cep");
    }
    else if (uf == "") {
        alertar("Por favor, selecione o estado!", "uf");
    }
    else if (cidade == "") {
        alertar("Por favor, selecione a cidade!", "cidade");
    }
    else if (tipoEndereco == "") {
        alertar("Por favor, selecione o tipo de endereço!", "tipoEndereco");
    }
    else if (tipoLogradouro == "") {
        alertar("Por favor, selecione o tipo de logradouro!", "tipoLogradouro");
    }
    else if (logradouro == "") {
        alertar("Por favor, informe o logradouro!", "logradouro");
    }
    else if (numero == "") {
        alertar("Por favor, informe o número!", "numero");
    }
    else if (complemento == "") {
        alertar("Por favor, informe o complemento!", "complemento");
    }
    else if (bairro == "") {
        alertar("Por favor, informe o bairro!", "bairro");
    }
    ...
    else if (areaCultural == "") {
        alertar("Por favor, selecione a área cultural!", "areaCultural");
    }
    else if (segmentoCultural == "") {
        alertar("Por favor, selecione o segmento cultural!", "segmentoCultural");
    }
...
function confirmarinsert() {
    ...
    if (cpf == "") {
        mostrar_menu_dados();
        alertar("Por favor, informe o número do CPF!", "cpf");
    }
    else if (nome == "") {
        mostrar_menu_dados();
        alertar("Por favor, informe o nome!", "nome");
        ...
        mostrar_menu_dados();
        alertar("Por favor, informe um nome válido!", "nome");
    }
    else if (cep == "") {
        mostrar_menu_dados();
        alertar("Por favor, informe o CEP!", "cep");
        ...
        mostrar_menu_dados();
        alertar("Por favor, selecione uma cidade!", "cidade");
    }
    else if (tipoEndereco == 0) {
        mostrar_menu_dados();
        alertar("Por favor, selecione um tipo de endereço!", "tipoEndereco");
    }
    else if (tipoLogradouro == 0) {
        mostrar_menu_dados();
        alertar("Por favor, selecione um tipo de logradouro!", "tipoLogradouro");
    }
    else if (logradouro == "") {
        mostrar_menu_dados();
        alertar("Por favor, informe o logradouro!", "logradouro");
    ...
    else if (areaCultural == 0) {
        mostrar_menu_dados();
        alertar("Por favor, selecione uma área cultural!", "areaCultural");
    }
    else if (segmentoCultural == 0) {
        mostrar_menu_dados();
        alertar("Por favor, selecione um segmento cultural!", "segmentoCultural");
    }

    // FONE
    else if (tipoFone == 0) {
        mostrar_menu_fone();
        alertar("Por favor, informe o tipo de telefone!", "tipoFone");
    }
    else if (ufFone == 0) {
        mostrar_menu_fone();
        alertar("Por favor, selecione o estado do telefone!", "ufFone");
    }
    else if (dddFone == 0) {
        mostrar_menu_fone();
        alertar("Por favor, informe ddd do telefone!", "dddFone");
    }
    else if (fone == "") {
        mostrar_menu_fone();
        ...
        mostrar_menu_fone();
        alertar("Por favor, informe um telefone válido!", "fone");
    }

    // E-MAIL
    else if (tipoEmail == 0) {
        mostrar_menu_email();
        alertar("Por favor, informe o tipo de email!", "tipoEmail");
    }
    else if (email == "") {
        mostrar_menu_email();
