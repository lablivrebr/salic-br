...
class Proposta_Model_TbCustosVinculados extends MinC_Db_Model
{
    ...
    const ID_ETAPA_CUSTOS_VINCULADOS = '8';
    const ID_FONTE_RECURSO_CUSTOS_VINCULADOS = '109';
    ...
    # SUL E SUDESTE
    const PERCENTUAL_DIVULGACAO_SUL_SUDESTE = 20;
    const PERCENTUAL_REMUNERACAO_CAPTACAO_DE_RECURSOS_SUL_SUDESTE = 10;
    const LIMITE_CAPTACAO_DE_RECURSOS_SUL_SUDESTE = 100000;

    # OUTRAS REGIOES
    const PERCENTUAL_DIVULGACAO_OUTRAS_REGIOES = 30;
    const PERCENTUAL_REMUNERACAO_CAPTACAO_DE_RECURSOS_OUTRAS_REGIOES = 15;
    const LIMITE_CAPTACAO_DE_RECURSOS_OUTRAS_REGIOES = 150000;
